export function getDateRange(option) {
    ...
    if (option === "today") {
      ...
      endDate = formatDateString(new Date(lastDayOfWeek.getFullYear(), lastDayOfWeek.getMonth(), lastDayOfWeek.getDate(), 23, 59));
      ...
      bitrixEndDate = formatBitrixDateString(new Date(lastDayOfWeek.getFullYear(), lastDayOfWeek.getMonth(), lastDayOfWeek.getDate(), 23, 59));
      dateType = 'week';
