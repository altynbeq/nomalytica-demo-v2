...
const WeaklyStatistics = (weekFinanceData) => {
    ...
    const weeklyStats = [
        ...
        },
        {
            icon: <FiStar />,
            amount: '001',
            // `${data.bestWorker.salesCount} продаж`,
            title: 'Топ продаж',
            desc: '001',
            // `Сотрудник ${data.bestWorker.id ? data.bestWorker.id : 'Пусто'}`,
        ...
        },
        {
            icon: <BsChatLeft />,
            amount: '001',
            // `${bestAvgCheckWorker.avgCheck ? bestAvgCheckWorker.avgCheck : 0} тг`,
            title: 'Топ средний чек',
            desc: '001',
            // `${bestAvgCheckWorker.id ? bestAvgCheckWorker.id : 'Пусто'}`,
            iconBg: '#00C292',
            pcColor: 'green-600',
        },
    ];
